...
\vspace{0.2cm}
\begin{itemize}
  \item বাংলা একটি কম-রিসোর্স ভাষা; উচ্চমানের OCR ও LLM টুলের অভাব রয়েছে।
  \item হাতে লেখা বাংলা অক্ষরের ভ্যারিয়েশন বেশি হওয়ায় OCR নির্ভুলতা কমে যায়।
  \item শিক্ষার্থীদের জন্য স্বয়ংক্রিয় টিউটরিং ও ব্যাখ্যা-সহায়তা জরুরি।
\end{itemize}
\end{block}
...
\begin{itemize}
  ...
  \item অফলাইন ডিপ্লয়মেন্ট বান্ধব আর্কিটেকচার।
\end{itemize}
\end{alertblock}
...
\begin{tikzpicture}[
  ...
  \node[box, below=of input] (pre) {প্রি-প্রসেসিং \\ (বৈসাদৃশ্য, আকার পরিবর্তন)};
  \node[box, below=of pre] (ocr) {OCR মডেল \\ (ResNet-34 + Grapheme ক্লাসিফায়ার)};
...
ডেমো পর্দা-চিত্র/ইন্টারফেস পূর্বরূপ এখানে যোগ করুন}}
\end{block}
...
\begin{itemize}
  ...
  \item Team Members: [Team Member 1], [Team Member 2], [Team Member 3]
...
\vspace{0.2cm}
\begin{itemize}
  \item \textbf{Email:} YOUR\_EMAIL@domain
  \item \textbf{GitHub:} github.com/YOUR\_GITHUB\_USERNAME/BhashaLLM
\end{itemize}
\vspace{0.2cm}
